          ...
          <CardHeader className="flex-row items-start justify-between gap-4">
            <div>
              ...
              <CardDescription className="mt-2">
                One record per crew per working day. The driver and the route
                distance come from the crew; a leg taken by taxi needs its fare
                instead.
              </CardDescription>
            </div>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                {isAdmin && <TableHead>Crew</TableHead>}
            ...
            <TableBody>
              {visibleDays.map((day) => (
                <TableRow key={day.id}>
                  ...
                  {isAdmin && <TableCell>{getCrewName(day.crewId)}</TableCell>}
                  <TableCell>
