...
import { clearAuth, getStoredSession, setAuthTokens, setStoredSession } from '@/lib/auth-tokens'
    ...
    () => ({
      ...
      login: async ({ login, password }) => {
        try {
          ...
          const meResponse = await apiClient.get<ApiResponse<CurrentUserResponse>>('/api/User/GetMe')
